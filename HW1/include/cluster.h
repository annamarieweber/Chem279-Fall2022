...
class Cluster{
  ...
  public:
     ...
     * where the first column is the atomic number and the remaing there columns are the x, y, and z coordinates
    ...
    /**
     * @brief calculates the distance between two atoms represented by 1d matricies with 3 values for x,y,and z respectively
     ...
     **/
    double calculateLJ(double r_ij, int i, int j);

    /**
     * @brief calculates the leanord jones potential energy of the cluster
     * @return double the total potentail energy
     **/
    double calcLJEnergy();
     ...
     * @param z (doubel): the z coordinate of the atom
